...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const en = {
			...
			quotaBraveHint: "Brave has no spend API. Capacity comes from rate-limit headers and matches the dashboard.",
		...
		const zh = {
			...
			quotaBraveHint: "Brave 没有花费接口。容量来自响应头，与控制台 Capacity 一致。",
		...
		const fieldRow = (label, hint, children, meta) => react.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "4px", padding: "12px 0", borderTop: "1px solid var(--dsw-alias-border-l2)" } },
			...
			children,
			meta?.invalid ? react.createElement("p", { style: { color: "var(--dsw-alias-label-error)", margin: 0, fontSize: "12px", lineHeight: "1.5" } }, meta.t("invalidNumber")) : null,
		...
		if (typeof document !== "undefined" && document.querySelector('style[data-plugin-css="' + CSS_ID + '"]') === null) {
			...
			tag.textContent = [
				...
				".dshws_card_header{display:flex;align-items:flex-start;gap:12px;padding:10px 0 4px}",
				...
				".dshws_input_invalid{border-color:var(--dsw-alias-label-error)!important}",
			...
			return react.createElement(react.Fragment, null,
				react.createElement(QuotaBar, {
					...
					resetText: monthlyCapped
						...
						: t("quotaBraveRpsWindow"),
					level,
					onRefresh,
					refreshing,
					t
				}),
				!monthlyCapped && monthly
					? react.createElement("p", { className: "dshws_quota_hint" }, t("quotaBraveUnlimited") + (monthly.resetAt ? " · " + tFill(t, "quotaResets", { time: formatResetTime(monthly.resetAt) }) : ""))
					: null,
				monthlyCapped && burst
					? react.createElement("p", { className: "dshws_quota_hint" }, tFill(t, "quotaBurst", { remaining: burst.remaining, limit: burst.limit }))
					: null,
				react.createElement("p", { className: "dshws_quota_hint" }, t("quotaBraveHint")));
		}
			...
			return react.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "4px" } },
				react.createElement("div", { className: "dshws_card_header" },
					react.createElement("div", { className: "dshws_card_headText" },
						...
						react.createElement("span", { className: "dshws_card_desc" }, t("description"))),
				...
				deepseek ? null : brave ? null : row("mode", t("mode"), null, selectInput({ id: "ws-mode", value: state.mode.text, disabled, onChange: (e) => actions.edit("mode", e.target.value), children: [
				...
				deepseek ? row("deepseekApiKeyEnv", t("deepseekApiKeyEnv"), t("deepseekApiKeyEnvHint"), textInput({ id: "ws-deepseek-keyref", value: state.deepseekApiKeyEnv.text, disabled, onChange: (e) => actions.edit("deepseekApiKeyEnv", e.target.value) })) : null,
				...
				brave ? row("braveApiKeyEnv", t("braveApiKeyEnv"), t("braveApiKeyEnvHint"), textInput({ id: "ws-brave-keyref", value: state.braveApiKeyEnv.text, disabled, onChange: (e) => actions.edit("braveApiKeyEnv", e.target.value) })) : null,
				...
				(!brave && !deepseek && keyed) ? row("apiKeyEnv", t("apiKeyEnv"), t("apiKeyEnvHint"), textInput({ id: "ws-tavily-keyref", value: state.apiKeyEnv.text, disabled, onChange: (e) => actions.edit("apiKeyEnv", e.target.value) })) : null,
				...
				deepseek ? row("model", t("model"), t("modelHint"), textInput({ id: "ws-model", value: state.model.text, disabled, onChange: (e) => actions.edit("model", e.target.value) })) : null,
				deepseek ? row("apiVersion", t("apiVersion"), t("apiVersionHint"), textInput({ id: "ws-apiversion", value: state.apiVersion.text, disabled, onChange: (e) => actions.edit("apiVersion", e.target.value) })) : null,
				deepseek ? row("maxTokens", t("maxTokens"), t("maxTokensHint"), textInput({ id: "ws-maxtokens", numeric: true, value: state.maxTokens.text, disabled, onChange: (e) => actions.edit("maxTokens", e.target.value), className: state.maxTokens.invalid ? "dshws_input_invalid" : void 0 })) : null,
				deepseek ? row("maxUses", t("maxUses"), t("maxUsesHint"), textInput({ id: "ws-maxuses", numeric: true, value: state.maxUses.text, disabled, onChange: (e) => actions.edit("maxUses", e.target.value), className: state.maxUses.invalid ? "dshws_input_invalid" : void 0 })) : null,
				(!brave && !deepseek) ? row("searchDepth", t("searchDepth"), null, selectInput({ id: "ws-depth", value: state.searchDepth.text, disabled, onChange: (e) => actions.edit("searchDepth", e.target.value), children: [
				...
				(!brave && !deepseek) ? row("topic", t("topic"), null, selectInput({ id: "ws-topic", value: state.topic.text, disabled, onChange: (e) => actions.edit("topic", e.target.value), children: [
				...
				(!brave && !deepseek) ? row("includeAnswer", t("includeAnswer"), t("includeAnswerHint"), checkboxInput({ id: "ws-answer", checked: state.includeAnswer.text === "true", disabled, onChange: (e) => actions.edit("includeAnswer", e.target.checked ? "true" : "") })) : null,
				brave ? row("country", t("country"), t("countryHint"), textInput({ id: "ws-country", value: state.country.text, disabled, onChange: (e) => actions.edit("country", e.target.value) })) : null,
				brave ? row("searchLang", t("searchLang"), t("searchLangHint"), textInput({ id: "ws-lang", value: state.searchLang.text, disabled, onChange: (e) => actions.edit("searchLang", e.target.value) })) : null,
				brave ? row("freshness", t("freshness"), null, selectInput({ id: "ws-freshness", value: state.freshness.text, disabled, onChange: (e) => actions.edit("freshness", e.target.value), children: [
				...
				brave ? row("proxy", t("proxy"), t("proxyHint"), textInput({ id: "ws-proxy", value: state.proxy.text, disabled, onChange: (e) => actions.edit("proxy", e.target.value) })) : null,
				row("maxResults", t("maxResults"), t("maxResultsHint"), textInput({ id: "ws-max", numeric: true, value: state.maxResults.text, disabled, onChange: (e) => actions.edit("maxResults", e.target.value), className: state.maxResults.invalid ? "dshws_input_invalid" : void 0 })),
